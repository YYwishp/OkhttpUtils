 ...
 */
public class MyRegionView8 extends View {
	private Rect rect1;
	private Rect rect2;
	private Paint paint;
	...
	public MyRegionView8(Context context) {
		super(context, null);
	}

	public MyRegionView8(Context context, @Nullable AttributeSet attrs) {
		super(context, attrs);
		//构造两个矩形
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawText("最终区域为region1 与 region2组合一起的区域",100,350,paint);
