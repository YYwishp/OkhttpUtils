 ...
 */
public class MyRegionView5 extends View {
	private Rect rect1;
	private Rect rect2;
	private Paint paint;
	...
	public MyRegionView5(Context context) {
		super(context, null);
	}

	public MyRegionView5(Context context, @Nullable AttributeSet attrs) {
		super(context, attrs);
		//构造两个矩形
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawText("最终区域为region1 与 region2不同的区域",100,350,paint);
