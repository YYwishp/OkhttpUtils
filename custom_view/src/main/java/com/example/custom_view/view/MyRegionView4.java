 ...
 */
public class MyRegionView4 extends View {
	private Rect rect1;
	private Rect rect2;
	private Paint paint;
	...
	public MyRegionView4(Context context) {
		super(context, null);
	}

	public MyRegionView4(Context context, @Nullable AttributeSet attrs) {
		super(context, attrs);
		//构造两个矩形
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawText("取两个区域的交集",100,350,paint);
