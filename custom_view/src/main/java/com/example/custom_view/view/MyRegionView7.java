 ...
 */
public class MyRegionView7 extends View {
	private Rect rect1;
	private Rect rect2;
	private Paint paint;
	...
	public MyRegionView7(Context context) {
		super(context, null);
	}

	public MyRegionView7(Context context, @Nullable AttributeSet attrs) {
		super(context, attrs);
		//构造两个矩形
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawText("最终区域为为region2的区域",100,350,paint);
